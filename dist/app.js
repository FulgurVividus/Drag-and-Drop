...
(function (enumProjectStatus) {
    enumProjectStatus[enumProjectStatus["ACTIVE"] = 0] = "ACTIVE";
    enumProjectStatus[enumProjectStatus["FINISHED"] = 1] = "FINISHED";
})(enumProjectStatus || (enumProjectStatus = {}));
class Project {
...
class ProjectState extends State {
    ...
    addProject(title, description, numOfPeople) {
        const newProject = new Project(Math.random().toString(), title, description, numOfPeople, enumProjectStatus.ACTIVE);
